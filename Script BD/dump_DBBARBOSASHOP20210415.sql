...
CREATE TABLE `tbl_itensvenda` (
  ...
  KEY `TBL_ITENSVENDA_FK01_idx` (`CODVENDA`),
  KEY `TBL_ITENSVENDA_FK02_idx` (`CODPRODUTO`),
  CONSTRAINT `TBL_ITENSVENDA_FK01` FOREIGN KEY (`CODVENDA`) REFERENCES `tbl_venda` (`CODVENDA`),
  CONSTRAINT `TBL_ITENSVENDA_FK02` FOREIGN KEY (`CODPRODUTO`) REFERENCES `tbl_produto` (`CODPRODUTO`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tbl_venda` (
  ...
  CONSTRAINT `TBL_VENDA_FK01` FOREIGN KEY (`CODCLIENTE`) REFERENCES `tbl_cliente` (`CODCLIENTE`),
  CONSTRAINT `TBL_VENDA_FK02` FOREIGN KEY (`CODSTATUSVENDA`) REFERENCES `tbl_statusvenda` (`CODSTATUSVENDA`),
  CONSTRAINT `TBL_VENDA_FK03` FOREIGN KEY (`CODSTATUSVENDA`) REFERENCES `tbl_tipopagamento` (`CODTIPOPAGAMENTO`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tbl_venda` VALUES (1,1,'2020-09-13',NULL,500.00,NULL,NULL),(2,1,'2021-04-12',NULL,100.00,NULL,NULL);
...
-- Dump completed on 2021-04-15 23:05:59
