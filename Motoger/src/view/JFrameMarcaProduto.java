...
public class JFrameMarcaProduto extends javax.swing.JDialog {

    public JFrameMarcaProduto() {
        initComponents();
        this.setModal(true);
        statusInicial(true);
    ...
    private void initComponents() {
        ...
        queryMarcaProduto = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("from MarcaProduto mp order by mp.mapMarcaProduto");
        ...
        setTitle("CADASTRO DE MARCAS DE PRODUTOS");
        setMaximumSize(new java.awt.Dimension(698, 339));
        ...
        org.jdesktop.swingbinding.JTableBinding jTableBinding = org.jdesktop.swingbinding.SwingBindings.createJTableBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, listMarcaProduto, jTableDados);
        org.jdesktop.swingbinding.JTableBinding.ColumnBinding columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${idMarcaProduto}"));
        columnBinding.setColumnName("Código");
        columnBinding.setColumnClass(Integer.class);
        columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${mapMarcaProduto}"));
        ...
        jTextFieldDescricao.setToolTipText("rizoma, sparka, dainese...");
        jTextFieldDescricao.setMaximumSize(new java.awt.Dimension(12, 30));

        org.jdesktop.beansbinding.Binding binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, jTableDados, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.mapMarcaProduto}"), jTextFieldDescricao, org.jdesktop.beansbinding.BeanProperty.create("text"));
        bindingGroup.addBinding(binding);

        jLabelDescricao.setFont(new java.awt.Font("Arial", 0, 11)); // NOI18N
        jLabelDescricao.setText("DESCRIÇÃO:");

        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, jTableDados, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.idMarcaProduto}"), jLabelCodGrupo, org.jdesktop.beansbinding.BeanProperty.create("text"));
        bindingGroup.addBinding(binding);
    ...
    private void jButtonNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonNovoActionPerformed
        ...
        listMarcaProduto.add(new MarcaProduto());
        int linha = listMarcaProduto.size() - 1;
    ...
    private void jButtonSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSalvarActionPerformed
        ...
        if(valida == 1){
            ...
            MarcaProduto map = listMarcaProduto.get(linhaSelecionada);
            try {
                ...
                try {
                    ...
                    if (e.getMessage().contains("chave estrangeira")){
                        JOptionPane.showMessageDialog(null, "Ocorreu um erro, a "
                            + "marca não foi excluída!\nErro: Marca está associada a um ou mais produtos");
                    } else {
                        JOptionPane.showMessageDialog(null, "Ocorreu um erro, a "
                            + "marca não foi excluída!\nErro: " + e);
                    }                   
    ...
    private void atualizaTabela(){
        ...
        if(jComboBoxTipoPesquisa.getSelectedItem().toString().equals("Código")){
            campoPesquisa = "mp.idMarcaProduto";
