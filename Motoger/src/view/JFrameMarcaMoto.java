...
public class JFrameMarcaMoto extends javax.swing.JDialog {

    public JFrameMarcaMoto() {
        initComponents();
        this.setModal(true);
        statusInicial(true);
    ...
    private void initComponents() {
        ...
        queryMarcaMoto = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("from MarcaMoto mm order by mm.marMarca");
        ...
        jLabelCodMarcaMoto = new javax.swing.JLabel();
        jPanel1 = new javax.swing.JPanel();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setTitle("CADASTRO DE MARCAS DE MOTOS");
        ...
        org.jdesktop.swingbinding.JTableBinding jTableBinding = org.jdesktop.swingbinding.SwingBindings.createJTableBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, listMarcaMoto, jTableDados);
        org.jdesktop.swingbinding.JTableBinding.ColumnBinding columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${idMarcaMoto}"));
        columnBinding.setColumnName("Código");
        columnBinding.setColumnClass(Integer.class);
        columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${marMarca}"));
        ...
        jPanelPesquisaLayout.setHorizontalGroup(
            ...
            .addGroup(jPanelPesquisaLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jButtonPesquisaOK, javax.swing.GroupLayout.DEFAULT_SIZE, 72, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        jTextFieldDescricao.setToolTipText("honda, yamaha, suzuki...");
        jTextFieldDescricao.setMaximumSize(new java.awt.Dimension(12, 30));

        org.jdesktop.beansbinding.Binding binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, jTableDados, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.marMarca}"), jTextFieldDescricao, org.jdesktop.beansbinding.BeanProperty.create("text"));
        bindingGroup.addBinding(binding);

        jLabelDescricao.setFont(new java.awt.Font("Arial", 0, 11)); // NOI18N
        jLabelDescricao.setText("DESCRIÇÃO:");

        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, jTableDados, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.idMarcaMoto}"), jLabelCodMarcaMoto, org.jdesktop.beansbinding.BeanProperty.create("text"));
        bindingGroup.addBinding(binding);
        ...
        jPanelSuperiorLayout.setHorizontalGroup(
            ...
            .addGroup(jPanelSuperiorLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jLabelCodMarcaMoto)
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jTextFieldDescricao, javax.swing.GroupLayout.PREFERRED_SIZE, 291, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jPanelBarraMensagem, javax.swing.GroupLayout.PREFERRED_SIZE, 424, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
    ...
    private void jButtonNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonNovoActionPerformed
        ...
        listMarcaMoto.add(new MarcaMoto());
        int linha = listMarcaMoto.size() - 1;
    ...
    private void jButtonSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSalvarActionPerformed
        ...
        if(valida == 1){
            ...
            MarcaMoto mam = listMarcaMoto.get(linhaSelecionada);
            try {
               entityManager.getTransaction().begin();
               entityManager.persist(mam);
               entityManager.getTransaction().commit();
                if (jLabelEstado.getText().equals("Alteração")) {
                    jLabelMensagem.setText("Dados da Marca alterados com sucesso!");
                } else {
                    jLabelMensagem.setText("Marca cadastrada com sucesso!");
                }
            } catch (Exception e){
                JOptionPane.showMessageDialog(null, "Ocorreu um erro, a marca não foi cadastrada!\nErro: " + e);
                jLabelMensagem.setText("Ocorreu um erro, a marca não foi cadastrada!");
    ...
    private void jButtonAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAlterarActionPerformed
        if(jTableDados.getSelectedRow() < 0){
            ...
            jLabelMensagem.setText("Alterando dados da marca...");
            statusInicial(false);
            controlePesquisa(false);
            atualizaControles();
        }
    ...
    private void jButtonExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonExcluirActionPerformed
        if(jTableDados.getSelectedRow() < 0){
            ...
            int confirmaExclusao = JOptionPane.showConfirmDialog(null, "Tem certeza que deseja excluir a marca? Essa operação não poderá ser desfeita!");
            if (confirmaExclusao == 0){ //sim
                int linhaSelecionada = jTableDados.getSelectedRow();
                MarcaMoto mam = listMarcaMoto.get(linhaSelecionada);
                try {
                    entityManager.getTransaction().begin();
                    entityManager.remove(mam);
                    entityManager.getTransaction().commit();
                    jLabelMensagem.setText("Marca excluída com sucesso!");
                } catch (Exception e) {
                    if (e.getMessage().contains("chave estrangeira")){
                        JOptionPane.showMessageDialog(null, "Ocorreu um erro, a "
                            + "marca não foi excluída!\nErro: Marca está associada a um ou mais veículos");
                    } else {
                        JOptionPane.showMessageDialog(null, "Ocorreu um erro, a "
                            + "marca não foi excluída!\nErro: " + e);
                    }                   
                    jLabelMensagem.setText("Ocorreu um erro, a marca não foi "
                            + "excluída!");
                    if(!entityManager.getTransaction().isActive())
                        entityManager.getTransaction().begin();
                    entityManager.getTransaction().rollback();
    ...
    private void atualizaTabela(){
        ...
        queryMarcaMoto = entityManager.createQuery(ejbql);
        listMarcaMoto.clear();
        listMarcaMoto.addAll(queryMarcaMoto.getResultList());
        int linha = listMarcaMoto.size() - 1;
        if(listMarcaMoto.size() > 0){
            ...
            jLabelMensagem.setText("Marca não cadastrada no sistema!");
        }
        if(listMarcaMoto.size() == 1){
            jTableDados.setRowSelectionInterval(linha, linha);
            atualizaControles();
        }else
            limparCampos();
    ...
    private javax.swing.JLabel jLabelCodMarcaMoto;
